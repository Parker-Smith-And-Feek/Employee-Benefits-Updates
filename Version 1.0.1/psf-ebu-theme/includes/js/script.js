      ...
      for (let webinar in webinarArray){
        ...
        if (webinar < 2){
          $( `<div class = 'webinar post' id = ${id}>
              ...
              if (recording !== ''){
                $(`<a class = 'recording' href ='${recording}' target ="_blank">View Online</a>`).appendTo($(`#${id}`));
              }
              if (presentation !== ''){
                $(`<a class = 'presentation' href ='${presentation}' target ="_blank">Download Slides</a>`).appendTo($(`#${id}`));
              }
              if (handout !== ''){
                $(`<a class = 'handout' href ='${handout}' target ="_blank">Download Handout</a>`).appendTo($(`#${id}`));
              }
            } else{
              $( `<div class = 'webinar post' id = ${id}>
                <h3 class = 'webinarTitle'>${title}</h3>
